...
Use these excerpts as factual grounding for the procedure, safety limits, component names, tool requirements, operation order, and completion criteria. Do not invent conflicting steps and do not mention source files or retrieval to the student.
