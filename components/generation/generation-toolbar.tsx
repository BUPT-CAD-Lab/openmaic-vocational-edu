          ...
          <Popover>
            <PopoverTrigger asChild>
              <button className={localKnowledge ? pillActive : pillMuted}>
                ...
                <span>{t('toolbar.localKnowledge')}</span>
              </button>
            </PopoverTrigger>
            <PopoverContent align="start" className="w-64 p-3 space-y-2">
              <button
                disabled={!localKnowledgeAvailable}
                onClick={() => {
                  if (localKnowledgeAvailable) onLocalKnowledgeChange(!localKnowledge);
                }}
                className={cn(
                  'w-full flex items-center gap-2.5 rounded-lg border px-3 py-2.5 text-left transition-all',
                  !localKnowledgeAvailable && 'cursor-not-allowed opacity-60',
                  localKnowledge
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs font-medium">
                    {localKnowledge
                      ? t('toolbar.localKnowledgeOn')
                      : t('toolbar.localKnowledgeOff')}
                  </p>
