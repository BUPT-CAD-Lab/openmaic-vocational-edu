...
export function CanvasArea({
  ...
  return (
    <div className="w-full h-full flex flex-col bg-gray-50 dark:bg-gray-900 group/canvas">
      ...
      <div
        className={cn(
          'flex-1 min-h-0 relative overflow-hidden flex items-center justify-center gap-2 p-2 transition-colors duration-500',
      ...
      >
        ...
        {currentScene && ragSnapshotId && !isPresenting && (
          <ClassroomRagEvidenceDock snapshotId={ragSnapshotId} sceneTitle={currentScene.title} />
        )}
      </div>
