      ...
      <div className="mx-auto max-w-5xl px-4 py-8">
        <div className="mb-7">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            上传课程材料后，文本、表格、公式与可描述图片将写入
            PostgreSQL，并使用配置的向量模型生成索引用于课程检索。
          </p>
        </div>
        ...
        <section className="mb-8">
          <input
            ref={inputRef}
            type="file"
            accept=".pdf,.docx,.pptx,.txt,.md,.markdown,.html,.htm,application/pdf,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/vnd.openxmlformats-officedocument.presentationml.presentation,text/plain,text/markdown,text/html"
            className="hidden"
            onChange={(event) => {
          ...
          >
            ...
            <div className="text-sm font-medium">
              {uploading ? '正在解析并生成向量...' : '上传课程材料'}
            </div>
            <div className="text-xs text-muted-foreground">
              支持 PDF、DOCX、PPTX、TXT、Markdown、HTML，最大 50 MB
            </div>
          </button>
        </section>
